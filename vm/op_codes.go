...
var OpCodes = []OpCode{
	...
	{SSTORE, "sstore", 1, []int{INT}, 1, 2},
	{LOAD, "load", 1, []int{BYTE}, 1, 2},
	{SLOAD, "sload", 1, []int{INT}, 1, 2},
	{ADDRESS, "address", 0, nil, 1, 2},
	{ISSUER, "issuer", 0, nil, 1, 2},
	{BALANCE, "balance", 0, nil, 1, 2},
	{CALLER, "caller", 0, nil, 1, 2},
	{CALLVAL, "callval", 0, nil, 1, 2},
	{CALLDATA, "calldata", 0, nil, 1, 2},
