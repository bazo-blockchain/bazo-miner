...
func TestMultipleBlocksWithTokenizationContractTx(t *testing.T) {
	...
	b := newBlock([32]byte{}, [32]byte{}, [32]byte{}, 1)
	contract := []byte{
		//35, 1, 0, 0, 1, 10, 22, 0, 11, 3, 50, 28, 1, 28, 0, 29, 1, 33, 10, 22, 0, 24, 2, 24, 28, 1, 28, 0, 1, 29, 2, 37, 22, 0, 46, 2, 28, 1, 28, 0, 29, 2, 38, 27, 2, 50, 28, 1, 29, 2, 39, 28, 1, 4, 29, 2, 40, 27, 2, 24
...
func TestMultipleBlocksWithTokenizationContractTxWhichAddsKey(t *testing.T) {
	...
	b := newBlock([32]byte{}, [32]byte{}, [32]byte{}, 1)
	contract := []byte{
		//35, 1, 0, 0, 1, 10, 22, 0, 11, 3, 50, 28, 0, 28, 1, 29, 1, 33, 10, 22, 0, 24, 2, 24, 28, 0, 29, 2, 37, 22, 0, 45, 2, 28, 0, 28, 1, 29, 2, 38, 27, 2, 50, 28, 1, 29, 2, 39, 28, 0, 4, 29, 2, 40, 27, 2, 24,
		35, 1, 0, 0, 1, 10, 22, 0, 11, 3, 50, 28, 1, 28, 0, 29, 1, 33, 10, 22, 0, 24, 2, 24, 28, 1, 28, 0, 1, 29, 2, 37, 22, 0, 46, 2, 28, 1, 28, 0, 29, 2, 38, 27, 2, 50, 28, 1, 29, 2, 39, 28, 0, 4, 28, 1, 29, 2, 40, 27, 2, 50,
	}
