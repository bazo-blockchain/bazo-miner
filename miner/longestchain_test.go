...
func TestGetBlockSequences(t *testing.T) {
	...
	b2 := protocol.NewBlock(b.Hash, b.Height+1)
	...
	//PoW needs lastBlock, have to set it manually
	lastBlock = c
	c2 := protocol.NewBlock(c.Hash, c.Height+1)
	...
	//PoW needs lastBlock, have to set it manually
	lastBlock = c2
	c3 := protocol.NewBlock(c2.Hash, c.Height+1)
	...
	lastBlock = c2
	c3 = protocol.NewBlock(c2.Hash, c2.Height+1)
	createBlockWithTxs(c3)
	finalizeBlock(c3)
